    ...
    foreach ($students as $student) {
        ...
        foreach ($scores as $score) {
            ...
            $formatted_scores[] = [
                ...
                'ca1' => isset($score_data['ca1']) ? (float)$score_data['ca1'] : null,
                'ca2' => isset($score_data['ca2']) ? (float)$score_data['ca2'] : null,
                'exam' => isset($score_data['exam']) ? (float)$score_data['exam'] : null,
                'max_ca1' => isset($score_data['max_ca1']) ? (float)$score_data['max_ca1'] : 20,
                'max_ca2' => isset($score_data['max_ca2']) ? (float)$score_data['max_ca2'] : 20,
                'max_exam' => isset($score_data['max_exam']) ? (float)$score_data['max_exam'] : 60
            ];
        }
            ...
            <?php if (empty(PORTAL_API_KEY) || PORTAL_API_KEY === 'YOUR_SCHOOL_API_KEY'): ?>
                <div class="config-warning">
                    ...
                    <code style="display: inline-block; margin-top: 10px; padding: 10px; background: #f0f0f0; border-radius: 5px;">
                        define('PORTAL_API_URL', 'https://impactdigitalacademy.com.ng/result-checker/admin/api/sync.php');<br>
